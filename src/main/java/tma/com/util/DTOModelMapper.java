...
public class DTOModelMapper extends RequestResponseBodyMethodProcessor {
    ...
    @Override
    protected Object readWithMessageConverters(HttpInputMessage inputMessage, MethodParameter parameter, Type targetType) throws IOException, 
